      ...
      <div className="flex-1 overflow-y-auto py-3">
        <div className="px-2 space-y-1">
          ...
          <div className="mt-1">
            <ExpandingDropdown
              trigger={                
              <div className="flex items-center justify-between px-2 py-1.5 text-xs md:text-sm rounded text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800 cursor-pointer transition-colors">
